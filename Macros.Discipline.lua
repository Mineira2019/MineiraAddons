...
function GMGenie.Macros.Discipline.Mute.run(name, title)
    if GMGenie_SavedVars.mute[title]["announceToServer"] then
        --SendChatMessage('.name ' .. name .. ' Ha sido muteado durante ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' minutes. Reason: ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
    else
        --SendChatMessage('.gmname ' .. name .. ' Ha sido muteado durante ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' minutes. Reason: ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
    end
    SendChatMessage('.mute ' .. name .. ' ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
	SendChatMessage('.send mail ' .. name .. ' "Muteo" ' .. '"Ha sido muteado por ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' minutos, Motivo. ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
end
...
function GMGenie.Macros.Discipline.CharBan.run(name, title)
    ...
    SendChatMessage('.ban playeraccount ' .. name .. ' ' .. GMGenie_SavedVars.charBan[title]["duration"] .. ' ' .. GMGenie_SavedVars.charBan[title]["reason"], "GUILD");
end
