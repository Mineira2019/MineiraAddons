...
function GMGenie.Tickets.optionsOnLoad()
    ...
    getglobal("GMGenie_Tickets_OptionsWindow_SubText"):SetText("Aqui puedes cambiar la configuración dle panel de tickets.");
																--Here you can change the settings for the ticket tracker
