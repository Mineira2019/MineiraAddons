...
function GMGenie.Macros.Discipline.optionsOnLoad()
    ...
    panel.name = "Macros Disciplina";
    panel.parent = "GM Genie";
    InterfaceOptions_AddCategory(panel);

    GMGenie_Macros_Discipline_OptionsWindow_Title:SetText("Macros Disciplina");
    GMGenie_Macros_Discipline_OptionsWindow_SubText:SetText("Aqui puedes agregar y modificar las macros de muteo y baneo que hay disponibles en la opción de Pj Info y el contenido del menu del jugador");
											--Here you add and update mute and ban macros, which will be available from the playerinfo window and the player context menus.
...
function GMGenie.Macros.Discipline.showOptions()
    InterfaceOptionsFrame_OpenToCategory("Macros Disciplina");
end
